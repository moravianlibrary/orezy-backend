...
class TestCoreUtils:
    ...
    def test_cxywh_to_xyxy_fractional_input(self):
        ...
        expected = (int(100.5 - 50.2/2), int(200.7 - 30.8/2), 
                   int(100.5 + 50.2/2), int(200.7 + 30.8/2))
    ...
    def test_bbox_intersection_basic(self):
        ...
        with patch('numpy.maximum') as mock_max, \
             patch('numpy.minimum') as mock_min:
    ...
    def test_bbox_from_image_contours_basic(self):
        ...
        mock_cv2.boxPoints.return_value = np.array([[50, 25], [150, 25], [150, 75], [50, 75]], dtype=np.float32)
    ...
    def test_assign_page_type_two_pages(self):
        ...
        scan = self.create_scan([self.right_page, self.left_page])  # Intentionally unsorted
